package com.protean.restful.apitest.baseAPI;
...
public static Map<String, Object> toMap(String object) throws IOException {
	  Map<String, Object> mapping = new ObjectMapper().readValue(object, HashMap.class);
	return mapping;
  }
  
  @SuppressWarnings("unchecked")
public Map<String, String> getKey(JSONObject json) throws JSONException {
	        ...
	        while(keys.hasNext()){
	            ...
	            try {
	                if(json.get(nextKeys) instanceof  JSONObject) {
	                    if(curLen>1) {
	                        getKey(json.getJSONObject(nextKeys));
	                    }
	                }
	                else{
