package com.enhops.restful.apitest.restassuredFuntions;
...
import com.enhops.restful.apitest.listeners.TestData;
...
public class GenerateRequest {
	...
	public static JSONObject getRequest() {
		...
		try {
			...
			switch (TestData.get("SearchType")) {
			case "Retail_Search":
			...
			try {
				...
				String authHeader = "Signature keyId=\"" + TestData.get("kid") + "\",algorithm=\"ed25519\", created=\""
						+ 1651483719 + "\", expires=\"" + (testTimestamp + 60000)
